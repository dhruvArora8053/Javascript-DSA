...
const mergeArrays1 = function (arr1, arr2) {
  const resultArr = [];
  let i = 0;
  let j = 0;
...
console.log(mergeArrays1([1, 2, 9], [3, 76]));
console.log(mergeArrays1([-10, -5, 9, 12, 23], [-96, 12, 34, 84]));
console.log(mergeArrays1([11, 33, 44, 55, 66], [6, 7, 8, 234, 576]));
console.log(mergeArrays1([1, 2], [3, 6]));
console.log(mergeArrays1([1], [7, 76]));
console.log(mergeArrays1([43], []));
